/* Automatically generated by p4c-ubpf from /home/iwai/p4c/testdata/p4_16_samples/ubpf.p4 on Sun Feb 18 06:52:36 2024
 */
#include "ubpf.h"
#include <stdint.h>
#include <stdbool.h>
    ...
    accept:
    {
        uint8_t tmp = 0;
        {
            ...
            if (headers.ipv4.protocol == 1) {
                if (headers.icmp.type_ == 3) {
                    if (headers.icmp.code == 3) {
